...
export const facilityLocations = [
  ...
  },
  {
    ...
    label: "Seton",
    images: {
      desktop: [seton1, seton2, seton3, seton4, seton5, seton6, seton7, seton8],
      mobile: [
        seton1Mobile,
        seton2Mobile,
        seton3Mobile,
  ...
  },
  {
    ...
    label: "North",
    images: {
      desktop: [north1, north2, north3, north4, north5, north6, north7, north8],
      mobile: [
        north1Mobile,
        north2Mobile,
        north3Mobile,
  ...
  },
  {
    ...
    label: "South",
    images: {
      desktop: [south1, south2, south3, south4, south5, south6, south7, south8],
      mobile: [
        south1Mobile,
        south2Mobile,
        south3Mobile,
...
// Helper function to get images for a specific device type
