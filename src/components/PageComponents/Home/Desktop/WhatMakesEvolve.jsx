...
const gymCards = [
  {
    ...
    video:
      assetUrl("/media/1760703686095-2b7f5707-b22c-41ab-b746-a1a23c6fa234.webm"),
    videomobile:
      assetUrl("/media/1760632418364-2ae4dfc4-dbf7-4a7e-b6bf-514a32eadcba.mp4"),
  },
  {
    title: "Room to Move",
    description:
    ...
    video:
      assetUrl("/media/1760703608053-568cac3d-912b-4505-99bb-84a94b9b79a6.webm"),
    videomobile:
      assetUrl("/media/1760632354725-62c014a5-4988-4976-a834-89d492aa8c6b.mp4"),
  },
  {
    title: "Atmosphere",
    description:
    ...
    video:
      assetUrl("/media/1760703643796-bfad9aab-51e1-4ed5-af09-1f804aff883b.webm"),
    videomobile:
      assetUrl("/media/1760632574411-b43edd39-e64a-46cc-8401-2b10f516aa6f.mp4"),
  },
];

const WhatMakesEvolve = () => {
            ...
            {gymCards.map((card, index) => {
              ...
              return (
                <div
                  ...
                  className="px-4 py-[32px] flex flex-col gap-4 cursor-pointer relative group overflow-hidden transition-all duration-75 transform hover:scale-[1.02] hover:shadow-lg"
                >
                  <div
                  ...
                  >
                    <h2
                      className={`capitalize mb-3 !text-[24px] font-semibold transition-all duration-75 group-hover:translate-y-[-2px] group-hover:opacity-90 ${
                        isActive ? "text-[#000]" : "text-[#ffffff]"
                      }`}
                    >
                      {card.title}
                    ...
                    <h4
                      className={`text-sm pr-2 transition-all duration-75 group-hover:translate-y-[-1px] group-hover:opacity-90 leading-[26px] ${
                        isActive ? "text-[#000]" : "text-[#ffffff]"
                      }`}
                    >
                      {card.description}
...
export default WhatMakesEvolve;
