      ...
      <div className="mx-auto max-w-[1280px] px-4 md:px-8">
        <div className="flex flex-col gap-10 py-8 lg:flex-row lg:items-center lg:gap-16 xl:gap-20 lg:rounded-br-[12px] lg:rounded-tr-[12px]">
          <h2
            ...
            className="text-[#000] uppercase font-[700] text-[28px] leading-[34px] md:text-[36px] md:leading-[42px] lg:text-[40px] lg:leading-[46px] max-w-[632px] shrink-0"
          >
              ...
              <a
                ...
                onClick={() =>
                  pushEvent("select_promotion", {
                    ...
                    creative_slot: "sec_bigger_everything_intro",
