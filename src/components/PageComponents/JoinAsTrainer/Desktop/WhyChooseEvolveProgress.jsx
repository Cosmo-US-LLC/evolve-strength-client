...
const DEFAULT_STEPS = [
  {
    ...
    image:
      assetUrl("/media/1762433209383-7ec3d881-bf94-44b0-95a0-cabbb0f5cca7.webp"),
      image_mob:assetUrl("/media/1763457725565-42ef4592-3a6f-4724-ae2f-fc7ce8e21f28.webp"),
    durationMs: 3500,
  },
  {
    key: "ownership",
    ...
    image:
      assetUrl("/media/1762433458101-71922c48-efe5-4316-8819-cd9ab672915f.webp"),
      image_mob:assetUrl("/media/1763452791053-81ef6470-60be-493c-9866-60f47bcab389.webp"),
    durationMs: 3500,
  },
  {
    key: "terms",
    ...
    image:
      assetUrl("/media/1762433190127-7fe3d82a-da37-42f3-816c-ced00e592b31.webp"),
       image_mob:assetUrl("/media/1763457755865-ae19e309-1495-415b-aeaf-4cec85dc2b5c.webp"),
    durationMs: 3500,
  },
  {
    key: "support",
    ...
    image:
      assetUrl("/media/1763109275796-6d568ae9-f44c-4e21-8c35-23aa41b58318.webp"),
       image_mob:assetUrl("/media/1763457774626-6e92df20-7a50-4161-9b6e-0c7c1909439c.webp"),
    durationMs: 3500,
  },
];
          ...
          {safeSteps.map((step, i) => (
            ...
            >
              ...
              <div className="text-white">
                ...
                <p className="!text-[16px] font-[Kanit] font-[300] leading-[26px] opacity-90">
                  {step.description}
                </p>
              </div>
            </div>
                    ...
                    <div className="flex-1">
                      <div className="relative min-h-[40px] h-full flex items-center">
                        ...
                        <div className="transition-all pl-4 duration-500 ease-in-out">
                          ...
                          >
                            <p className="leading-[130%] text-[14px] font-[Kanit] font-[300] text-white opacity-90">
                              {step.description}
                            </p>
                          </div>
                        </div>
                      ...
                      {isActive && (
                        <div className="w-full flex justify-center mt-4 h-[400px]">
                          <img
                            ...
                            src={step.image}
                            alt={step.title}
                            className="rounded-[10px] max-md:hidden object-cover w-full shadow"
                          />
                            <img
                            key={step.image}
                            src={step.image_mob}
                            alt={step.title}
                            className="rounded-[10px] md:hidden object-cover w-full  shadow"
                          />
                        </div>
                      )}
                    </div>
