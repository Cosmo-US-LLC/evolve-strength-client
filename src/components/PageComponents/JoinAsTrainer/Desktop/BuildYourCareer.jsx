...
function BuildYourCareer() {
  return (
    <div className="w-full pb-12 pt-[0px] md:pt-[60px]">
  ...
  <div className="flex flex-col gap-[12px] mt-[60px]">
    ...
    />
                ...
                <div className="grid grid-cols-9 gap-x-1 gap-y-2 items-start">
                  <div className="flex flex-col gap-[4px] mt-[60px]">
                    <img
                      src={build_img1}
                      alt="Bearded man"
                      className="w-[40px] h-[48px] rounded-[2.7px] object-cover shadow-md"
                    />
                    <img
                      src={build_img2}
                      alt="Woman with trophy"
                  ...
                  <div className="flex flex-col justify-center gap-[4px] mt-[40px]">
                    <img
                      src={build_img3}
                      alt="Woman in green polka dot"
                      className="w-[40px] h-[48px] rounded-[2.7px] object-cover shadow-md"
                  ...
                  <div className="flex flex-col gap-[4px] mt-[40px]">
                    <img
                       src={build_img10}
                      alt="Woman in workout clothes"
                      className="w-[40px] h-[48px] rounded-[2.7px] object-cover shadow-md"
              ...
              <div className="hidden md:block absolute top-[80%] inset-0 flex items-center justify-center">
