  ...
  const testimonialData = [
    {
      ...
      image: "/media/1763534076893-64e82bc5-74f9-415f-b808-7684205b85a8.webp",
      testimonial:
    ...
    },
    {
      ...
      role: "Personal Trainer",
      image: "/media/1763534093871-9406ebe5-3de7-40f2-bd90-2c107b40564f.webp",
      testimonial:
    ...
    },
    {
      name: "Bailey Lau",
      role: "Personal Trainer",
      image: "/media/1763534137537-73ae684e-f7ed-4ba3-9b77-9b93668bb1e0.webp",
      testimonial:
...
const scrollNext = () => {
  ...
  const StarRating = () => (
    <div className="flex items-start">
      {[...Array(5)].map((_, i) => (
        <img key={i} src={"/media/1763534481120-e82e9280-83df-4586-a1ef-2ab02000a801.webp"} alt="star" className="w-8 h-8" />
      ))}
    </div>
  );
