...
const gymCards = [
  {
    ...
    description: "Employees can train, recover, and get healthcare support without leaving the facility. No need to travel between appointments.",
    bgImage: fitness,
  },
  {
    count: "02",
    title: <p>Top-tier Gym Equipment</p>,
    description: "Each location offers physiotherapy, massage, chiropractic, acupuncture, and more. Plus steam rooms, saunas and showers.",
    bgImage: wellness,
  },
  {
    count: "03",
    title: "Full Wellness Support",
    description: "Our spaces feature Precor, Rogue, Eleiko, and Atlantis gear. That includes strength platforms, cardio machines, and turf zones.",
    bgImage: atmosphere,
  },
  {
    count: "04",
    ...
    description: "When employees use their benefits, they feel better, get injured less, and take fewer sick days. That improves productivity and morale.",
  ...
  return (
    <div className="relative w-full overflow-hidden mb-12">
      ...
      <div className="relative z-10 w-full max-w-[1280px] mx-auto flex flex-col items-start justify-start gap-4 px-8">
        ...
        <button className="btnPrimary absolute top-[280px]">Book a Free Consultation</button>
      </div>
        ...
        {gymCards.map((card, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <h4
                  className={`uppercase !text-[24px] font-Vazirmatn leading-[24px] tracking-[-0.72px] !font-[500] mb-2 transition-all duration-200 group-hover:translate-y-[-4px] group-hover:opacity-90 ${
                    isActive ? "text-[#1C1C1C]" : "text-[#ffffff]"
                  }`}
                >
                  {card.title}
                                ...
                                <p
                  className={`leading-[24px] !font-[400] font-vazirmatn transition-all duration-200 group-hover:translate-y-[-2px] group-hover:opacity-90 ${
