...
const PremiumAmenitiesForYou = () => {
  ...
  const cardData = [
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card1.webp"),
      title: "On-Site Parking",
      description: "Always find a convenient spot close to the main entrance.",
    },
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card2.webp"),
      title: "Locker Rooms",
      description:
        "Secure, spacious locker rooms to store your personal items.",
    },
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card3.webp"),
      title: "Showers",
      description: "Clean, private showers to refresh after every workout.",
    },
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card4.webp"),
      title: "Steam Rooms and Saunas",
      description:
        "Relax and recover in our premium in-house steam rooms and saunas.",
    },
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card5.webp"),
      title: "Premium Waiting Area",
      description:
        "A quiet, comfortable space to relax before or after your session.",
    },
    {
      imageUrl: assetUrl("/assets/images/MembershipBenefits/PremiumAmenitiesForYou/card6.webp"),
