    ...
    <div>
      <div className="max-md:hidden">
        <div className="max-w-[1280px] px-8 pb-[80px] mx-auto w-full h-full mt-30 flex flex-col md:flex-row md:gap-[24px] p-6 md:p-12">
          ...
          {/* Main Content */}
          <div className="w-full md:ml-[300px] pl-6 space-y-6 ">
            <h1 className=" !text-[40px] !font-[700] ">Privacy Policy</h1>

            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Information We Collect</h3>
              <h4 id="collect-p" className="leading-normal text-[#000] !font-[kanit] font-[300] !text-[18px] ">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Use of Information</h3>
              <h4 id="use-p" className="leading-normal text-[#000] !font-[kanit] font-[300]">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Cookies</h3>
              <h4 id="cookies-p" className="leading-normal text-[#000] !font-[kanit] font-[300]">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Data Storage and Security</h3>
              <h4 id="storage-p" className="leading-normal text-[#000] !font-[kanit] font-[300]">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Sharing of Information</h3>
              <h4 id="sharing-p" className="leading-normal text-[#000] !font-[kanit] font-[300]">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="!text-[20px] font-Kanit leading-normal">Your Rights</h3>
              <h4 id="rights-p" className="leading-normal text-[#000] !font-[kanit] font-[300]">
